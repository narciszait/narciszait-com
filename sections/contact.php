...
<div id="contactform"  class="contact">
	<form action="send.php" method="post" >
    	...
    	<!-- YOUR EMAIL ADDRESS -->
    	<input name="repemail" id="repemail" type="hidden" value="narcis@narciszait.com" />
    	<!-- ENTER YOUR URL BELOW: MUST CONTAIN #contact AT THE END OF THE URL-->
    	<input name="pagelink" id="pagelink" type="hidden" value="http://www.narciszait.com/#contact" />
